...
import HSL.types.GetPerson;
import HSL.types.GetPersonResponse;

@WebService(serviceName = "PersonService", endpointInterface = "HSL.Person")
public class PersonImpl implements Person {
        ...
        throws UnknownPersonFault
    {
        if (personId.value == null || personId.value.length() == 0) {
            HSL.types.UnknownPersonFault fault = new HSL.types.UnknownPersonFault();
